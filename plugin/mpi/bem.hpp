...
template <class Matrix, class R, typename P, typename MeshBemtool, class MMesh>
void ff_POT_Generator(Matrix* Hmat,BemPotential *typePot, bemtool::Dof<P> &dof, MeshBemtool &mesh, bemtool::Geometry &node_output, string compressor,vector<double> &p1,vector<double> &p2,MPI_Comm comm) {
    ...
    switch (pot) {
        case bemtool::SL_POT :
            if (kappaRe && !kappaIm) {
                bemtool::Potential<bemtool::PotKernel<HE,bemtool::SL_POT,MMesh::RdHat::d+1,P>> t(mesh,kappaRe);
                bemtool::POT_Generator<bemtool::PotKernel<HE,bemtool::SL_POT,MMesh::RdHat::d+1,P>,P> generator(t,dof,node_output);
                if(mpirank == 0 && verbosity>5) cout << "call bemtool func POT_Generator<HE,SL_POT ..." << endl;
                Assembly(Hmat,&generator,compressor,p1,p2,comm,MMesh::RdHat::d+1);
            }
            else if (!kappaRe && kappaIm) {
                bemtool::Potential<bemtool::PotKernel<YU,bemtool::SL_POT,MMesh::RdHat::d+1,P>> t(mesh,kappaIm);
                bemtool::POT_Generator<bemtool::PotKernel<YU,bemtool::SL_POT,MMesh::RdHat::d+1,P>,P> generator(t,dof,node_output);
                if(mpirank == 0 && verbosity>5) cout << "call bemtool func POT_Generator<YU,SL_POT ..." << endl;
                Assembly(Hmat,&generator,compressor,p1,p2,comm,MMesh::RdHat::d+1);
            }
            else if (!kappaRe && !kappaIm){  //kappaRe=0
                bemtool::Potential<bemtool::PotKernel<LA,bemtool::SL_POT,MMesh::RdHat::d+1,P>> t(mesh,kappaRe);
                bemtool::POT_Generator<bemtool::PotKernel<LA,bemtool::SL_POT,MMesh::RdHat::d+1,P>,P> generator(t,dof,node_output);
        ...
        case bemtool::DL_POT :
            if (kappaRe && !kappaIm) {
                bemtool::Potential<bemtool::PotKernel<HE,bemtool::DL_POT,MMesh::RdHat::d+1,P>> t(mesh,kappaRe);
                bemtool::POT_Generator<bemtool::PotKernel<HE,bemtool::DL_POT,MMesh::RdHat::d+1,P>,P> generator(t,dof,node_output);
                if(mpirank == 0 && verbosity>5) cout << "call bemtool func POT_Generator<HE,DL_POT ..." << endl;
                Assembly(Hmat,&generator,compressor,p1,p2,comm,MMesh::RdHat::d+1);
            }
            if (!kappaRe && kappaIm) {
                           bemtool::Potential<bemtool::PotKernel<YU,bemtool::DL_POT,MMesh::RdHat::d+1,P>> t(mesh,kappaIm);
                           bemtool::POT_Generator<bemtool::PotKernel<YU,bemtool::DL_POT,MMesh::RdHat::d+1,P>,P> generator(t,dof,node_output);
                           if(mpirank == 0 && verbosity>5) cout << "call bemtool func POT_Generator<YU,DL_POT ..." << endl;
                           Assembly(Hmat,&generator,compressor,p1,p2,comm,MMesh::RdHat::d+1);
                       }
            else if (!kappaRe && !kappaIm){ //kappaRe=0
                bemtool::Potential<bemtool::PotKernel<LA,bemtool::DL_POT,MMesh::RdHat::d+1,P>> t(mesh,kappaRe);
                bemtool::POT_Generator<bemtool::PotKernel<LA,bemtool::DL_POT,MMesh::RdHat::d+1,P>,P> generator(t,dof,node_output);
